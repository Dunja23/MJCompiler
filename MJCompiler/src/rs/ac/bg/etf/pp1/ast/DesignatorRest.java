...
public class DesignatorRest extends DesignatorStatement {

    private OptDesignatorList OptDesignatorList;
    private Designator Designator;
    private Designator Designator1;

    public DesignatorRest (OptDesignatorList OptDesignatorList, Designator Designator, Designator Designator1) {
