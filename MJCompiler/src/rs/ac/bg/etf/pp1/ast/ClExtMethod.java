...
public class ClExtMethod extends ClassDecl {
    ...
    public ClExtMethod (String I1, Type Type, StaticVarDeclList StaticVarDeclList, StaticInitializerList StaticInitializerList, MethodDeclList MethodDeclList) {
        this.I1=I1;
        this.Type=Type;
