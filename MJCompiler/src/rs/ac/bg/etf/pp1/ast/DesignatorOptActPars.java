...
public class DesignatorOptActPars extends DesignatorStatement {

    private Designator Designator;
    private OptActPars OptActPars;

    public DesignatorOptActPars (Designator Designator, OptActPars OptActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorOptActPars(\n");
