...
public class ClExtVar extends ClassDecl {
    ...
    public ClExtVar (String I1, Type Type, StaticVarDeclList StaticVarDeclList, StaticInitializerList StaticInitializerList, VarDeclarList VarDeclarList) {
        this.I1=I1;
        this.Type=Type;
